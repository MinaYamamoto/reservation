...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param= [
            ...
            'thumbnail' => '/storage/post_img/sushi.jpg',
        ];
        ...
        $param= [
            ...
            'thumbnail' => '/storage/post_img/yakiniku.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '戦慄',
            ...
            'thumbnail' => '/storage/post_img/izakaya.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => 'ルーク',
            ...
            'thumbnail' => '/storage/post_img/italian.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '志摩屋',
            ...
            'thumbnail' => '/storage/post_img/ramen.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '香',
