...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param= [
            ...
            'thumbnail' => '/storage/post_img/sushi.jpeg',
        ];
        ...
        $param= [
            ...
            'thumbnail' => '/storage/post_img/yakiniku.jpeg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '戦慄',
            ...
            'thumbnail' => '/storage/post_img/izakaya.jpeg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => 'ルーク',
            ...
            'thumbnail' => '/storage/post_img/italian.jpeg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '志摩屋',
            ...
            'thumbnail' => '/storage/post_img/ramen.jpeg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '香',
