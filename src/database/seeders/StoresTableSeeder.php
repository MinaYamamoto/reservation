...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param= [
            ...
            'thumbnail' => 'public/post_img/sushi.jpg',
        ];
        ...
        $param= [
            ...
            'thumbnail' => 'public/post_img/yakiniku.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '戦慄',
            ...
            'thumbnail' => 'public/post_img/izakaya.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => 'ルーク',
            ...
            'thumbnail' => 'public/post_img/italian.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '志摩屋',
            ...
            'thumbnail' => 'public/post_img/ramen.jpg',
        ];
        DB::table('stores')->insert($param);
        $param= [
            'name' => '香',
